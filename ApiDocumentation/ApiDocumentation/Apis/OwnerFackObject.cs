...
{
    public class OwnerFackObject : IHasStaticProperty<List<Owner>>
    {
        ...
        public static List<Owner> StaticProperty { get; set; } = Owners;
    }

    interface IHasStaticProperty<T>
    {
        static abstract T StaticProperty { get; set; }
    }
}